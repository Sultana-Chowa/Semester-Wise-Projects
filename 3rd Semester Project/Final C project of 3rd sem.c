/*
7. Team Terminators
Project is about store management system. This project is made for making a easier process to maintain a departmental store.
*/
...
void welcome(void)
{
	...
	printf("                                                                                                          \n\n\n\n\n\n\n\n");
	printf("\t\t\t|-------------------------------------------------------------------------------------------------------|\n");
	printf("\t\t\t|\t\t\t\t\t%s",ctime(&t));//This will show the time, date, day, month and year
	printf("\t\t\t|-------------------------------------------------------------------------------------------------------|\n");
	printf("\t\t\t|                                                                                                       |\n");
	printf("\t\t\t|                                                                                                       |\n");
	printf("\t\t\t|                                                                                                       |\n");
...
printf("\n\n\n\n\n\t\t\t\t\t |----------------------------------------------------------|\n");
      ...
      system("cls");
          if(b==3)
          {
               mainT();//calling the management page
          }
          else if(b==2)
          {
...
for(i=0; i<=2000;i++)
     ...
     scanf("%i", &cn.j);//number of product customer wants to buy
for(i=0;i<cn.j; i++)
     {
     if((fp=fopen("NextFile.dat","r+"))==NULL)//checking if there is any product details or not
	{
		printf("\n   NO RECORD ADDED.");
		printf("\n\n\tPress any key to go to add product from product section......");
		getch();
		enu();// calling product section page
	}
          else
	{
		rp = fopen("TempFile.dat","a");
		//opening a temporary file for the execution
